...
set C_modelArgList {
	{ in_val_V_read int 32 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in_val_V_read", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ in_val_V_read sc_in sc_lv 32 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_val_V_read", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "in_val_V_read", "role": "default" }} , 
...
set Spec2ImplPortList { 
	in_val_V_read { ap_none {  { in_val_V_read in_data 0 32 } } }
}
