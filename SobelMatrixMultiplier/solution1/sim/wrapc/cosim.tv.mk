...
$(ObjDir)/SobelMatrixMultiplier_test.cpp_pre.cpp.tb.o : SobelMatrixMultiplier_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling SobelMatrixMultiplier_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/SobelMatrixMultiplier.cpp_pre.cpp.tb.o : SobelMatrixMultiplier.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling SobelMatrixMultiplier.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
