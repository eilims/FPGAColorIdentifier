; ModuleID = 'D:/Repositories/FPGAColorIdentifier/SobelMatrixMultiplier/solution2/.autopilot/db/a.g.1.bc'
...
; <label>:4                                       ; preds = %3
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !72 ; [debug line = 9:1]
  ...
  call void @llvm.dbg.value(metadata !{i32 %summation.2}, i64 0, metadata !73), !dbg !67 ; [debug line = 9:4] [debug variable = summation]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !74 ; [#uses=0 type=i32] [debug line = 10:3]
  %col.1 = add nsw i32 %col, 1, !dbg !75          ; [#uses=1 type=i32] [debug line = 8:35]
  call void @llvm.dbg.value(metadata !{i32 %col.1}, i64 0, metadata !76), !dbg !75 ; [debug line = 8:35] [debug variable = col]
  br label %3, !dbg !75                           ; [debug line = 8:35]

; <label>:5                                       ; preds = %3
  %summation.1.lcssa = phi i32 [ %summation.1, %3 ] ; [#uses=1 type=i32]
  %rend3 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str, i64 0, i64 0), i32 %rbegin2) nounwind, !dbg !77 ; [#uses=0 type=i32] [debug line = 11:2]
  %row.1 = add nsw i32 %row, 1, !dbg !78          ; [#uses=1 type=i32] [debug line = 7:34]
  call void @llvm.dbg.value(metadata !{i32 %row.1}, i64 0, metadata !79), !dbg !78 ; [debug line = 7:34] [debug variable = row]
  br label %1, !dbg !78                           ; [debug line = 7:34]

; <label>:6                                       ; preds = %1
  %summation.0.lcssa = phi i32 [ %summation, %1 ] ; [#uses=1 type=i32]
  ret i32 %summation.0.lcssa, !dbg !80            ; [debug line = 12:2]
}

; [#uses=1]
define internal fastcc i32 @getHorizontalResult([3 x i32]* %array) nounwind uwtable {
  call void @llvm.dbg.value(metadata !{[3 x i32]* %array}, i64 0, metadata !81), !dbg !82 ; [debug line = 17:29] [debug variable = array]
  call void (...)* @_ssdm_SpecArrayDimSize([3 x i32]* %array, i32 3) nounwind, !dbg !83 ; [debug line = 17:43]
  br label %1, !dbg !85                           ; [debug line = 19:23]

; <label>:1                                       ; preds = %5, %0
  %row = phi i32 [ 0, %0 ], [ %row.2, %5 ]        ; [#uses=3 type=i32]
  %summation = phi i32 [ 0, %0 ], [ %summation.1.lcssa, %5 ] ; [#uses=2 type=i32]
  %exitcond1 = icmp eq i32 %row, 3, !dbg !85      ; [#uses=1 type=i1] [debug line = 19:23]
  br i1 %exitcond1, label %6, label %2, !dbg !85  ; [debug line = 19:23]

; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !87 ; [debug line = 19:42]
  %rbegin2 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !87 ; [#uses=1 type=i32] [debug line = 19:42]
  %tmp = sext i32 %row to i64, !dbg !89           ; [#uses=2 type=i64] [debug line = 21:4]
  br label %3, !dbg !92                           ; [debug line = 20:24]

; <label>:3                                       ; preds = %4, %2
  %summation.1 = phi i32 [ %summation, %2 ], [ %summation.3, %4 ] ; [#uses=2 type=i32]
  %col = phi i32 [ 0, %2 ], [ %col.2, %4 ]        ; [#uses=3 type=i32]
  %exitcond = icmp eq i32 %col, 3, !dbg !92       ; [#uses=1 type=i1] [debug line = 20:24]
  br i1 %exitcond, label %5, label %4, !dbg !92   ; [debug line = 20:24]

; <label>:4                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !93 ; [debug line = 20:43]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !93 ; [#uses=1 type=i32] [debug line = 20:43]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !94 ; [debug line = 21:1]
  %tmp.7 = sext i32 %col to i64, !dbg !89         ; [#uses=2 type=i64] [debug line = 21:4]
  %array.addr = getelementptr inbounds [3 x i32]* %array, i64 %tmp, i64 %tmp.7, !dbg !89 ; [#uses=1 type=i32*] [debug line = 21:4]
  %array.load = load i32* %array.addr, align 4, !dbg !89 ; [#uses=2 type=i32] [debug line = 21:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %array.load) nounwind
  %_horizontal_sobel_operator.addr = getelementptr inbounds [3 x [3 x i32]]* @_horizontal_sobel_operator, i64 0, i64 %tmp, i64 %tmp.7, !dbg !89 ; [#uses=1 type=i32*] [debug line = 21:4]
  %_horizontal_sobel_operator.load = load i32* %_horizontal_sobel_operator.addr, align 4, !dbg !89 ; [#uses=2 type=i32] [debug line = 21:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %_horizontal_sobel_operator.load) nounwind
  %tmp.8 = mul nsw i32 %_horizontal_sobel_operator.load, %array.load, !dbg !89 ; [#uses=1 type=i32] [debug line = 21:4]
  %summation.3 = add nsw i32 %tmp.8, %summation.1, !dbg !89 ; [#uses=1 type=i32] [debug line = 21:4]
  call void @llvm.dbg.value(metadata !{i32 %summation.3}, i64 0, metadata !95), !dbg !89 ; [debug line = 21:4] [debug variable = summation]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !96 ; [#uses=0 type=i32] [debug line = 22:3]
  %col.2 = add nsw i32 %col, 1, !dbg !97          ; [#uses=1 type=i32] [debug line = 20:35]
  call void @llvm.dbg.value(metadata !{i32 %col.2}, i64 0, metadata !98), !dbg !97 ; [debug line = 20:35] [debug variable = col]
  br label %3, !dbg !97                           ; [debug line = 20:35]

; <label>:5                                       ; preds = %3
  %summation.1.lcssa = phi i32 [ %summation.1, %3 ] ; [#uses=1 type=i32]
  %rend3 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str, i64 0, i64 0), i32 %rbegin2) nounwind, !dbg !99 ; [#uses=0 type=i32] [debug line = 23:2]
  %row.2 = add nsw i32 %row, 1, !dbg !100         ; [#uses=1 type=i32] [debug line = 19:34]
  call void @llvm.dbg.value(metadata !{i32 %row.2}, i64 0, metadata !101), !dbg !100 ; [debug line = 19:34] [debug variable = row]
  br label %1, !dbg !100                          ; [debug line = 19:34]

; <label>:6                                       ; preds = %1
  %summation.0.lcssa = phi i32 [ %summation, %1 ] ; [#uses=1 type=i32]
  ret i32 %summation.0.lcssa, !dbg !102           ; [debug line = 24:2]
}

; [#uses=0]
define i32 @getConvolutionResult([3 x i32]* %array) nounwind uwtable {
  call void (...)* @_ssdm_op_SpecBitsMap(i32 0) nounwind, !map !103
  call void (...)* @_ssdm_op_SpecTopModule([21 x i8]* @getConvolutionResult.str) nounwind
  call void @llvm.dbg.value(metadata !{[3 x i32]* %array}, i64 0, metadata !109), !dbg !110 ; [debug line = 36:30] [debug variable = array]
  call void (...)* @_ssdm_SpecArrayDimSize([3 x i32]* %array, i32 3) nounwind, !dbg !111 ; [debug line = 36:43]
  %tmp = call fastcc i32 @getVerticalResult([3 x i32]* %array), !dbg !113 ; [#uses=1 type=i32] [debug line = 37:32]
  %tmp.11 = call fastcc i32 @getHorizontalResult([3 x i32]* %array), !dbg !114 ; [#uses=1 type=i32] [debug line = 37:58]
  %tmp.12 = call fastcc i32 @combineOperatorResults(i32 %tmp, i32 %tmp.11), !dbg !114 ; [#uses=1 type=i32] [debug line = 37:58]
  ret i32 %tmp.12, !dbg !114                      ; [debug line = 37:58]
}

; [#uses=1]
define internal fastcc i32 @combineOperatorResults(i32 %verticalResult, i32 %horizontalResult) nounwind uwtable {
  call void @llvm.dbg.value(metadata !{i32 %verticalResult}, i64 0, metadata !115), !dbg !116 ; [debug line = 30:32] [debug variable = verticalResult]
  call void @llvm.dbg.value(metadata !{i32 %horizontalResult}, i64 0, metadata !117), !dbg !118 ; [debug line = 30:52] [debug variable = horizontalResult]
  %tmp = add nsw i32 %horizontalResult, %verticalResult, !dbg !119 ; [#uses=1 type=i32] [debug line = 31:2]
  ret i32 %tmp, !dbg !119                         ; [debug line = 31:2]
}
...
!72 = metadata !{i32 9, i32 1, metadata !68, null}
!73 = metadata !{i32 786688, metadata !62, metadata !"summation", metadata !6, i32 6, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!74 = metadata !{i32 10, i32 3, metadata !68, null}
!75 = metadata !{i32 8, i32 35, metadata !69, null}
!76 = metadata !{i32 786688, metadata !69, metadata !"col", metadata !6, i32 8, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!77 = metadata !{i32 11, i32 2, metadata !66, null}
!78 = metadata !{i32 7, i32 34, metadata !64, null}
!79 = metadata !{i32 786688, metadata !64, metadata !"row", metadata !6, i32 7, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!80 = metadata !{i32 12, i32 2, metadata !62, null}
!81 = metadata !{i32 786689, metadata !16, metadata !"array", metadata !6, i32 16777233, metadata !10, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!82 = metadata !{i32 17, i32 29, metadata !16, null}
!83 = metadata !{i32 17, i32 43, metadata !84, null}
!84 = metadata !{i32 786443, metadata !16, i32 17, i32 42, metadata !6, i32 5} ; [ DW_TAG_lexical_block ]
!85 = metadata !{i32 19, i32 23, metadata !86, null}
!86 = metadata !{i32 786443, metadata !84, i32 19, i32 7, metadata !6, i32 6} ; [ DW_TAG_lexical_block ]
!87 = metadata !{i32 19, i32 42, metadata !88, null}
!88 = metadata !{i32 786443, metadata !86, i32 19, i32 41, metadata !6, i32 7} ; [ DW_TAG_lexical_block ]
!89 = metadata !{i32 21, i32 4, metadata !90, null}
!90 = metadata !{i32 786443, metadata !91, i32 20, i32 42, metadata !6, i32 9} ; [ DW_TAG_lexical_block ]
!91 = metadata !{i32 786443, metadata !88, i32 20, i32 8, metadata !6, i32 8} ; [ DW_TAG_lexical_block ]
!92 = metadata !{i32 20, i32 24, metadata !91, null}
!93 = metadata !{i32 20, i32 43, metadata !90, null}
!94 = metadata !{i32 21, i32 1, metadata !90, null}
!95 = metadata !{i32 786688, metadata !84, metadata !"summation", metadata !6, i32 18, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!96 = metadata !{i32 22, i32 3, metadata !90, null}
!97 = metadata !{i32 20, i32 35, metadata !91, null}
!98 = metadata !{i32 786688, metadata !91, metadata !"col", metadata !6, i32 20, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!99 = metadata !{i32 23, i32 2, metadata !88, null}
!100 = metadata !{i32 19, i32 34, metadata !86, null}
!101 = metadata !{i32 786688, metadata !86, metadata !"row", metadata !6, i32 19, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!102 = metadata !{i32 24, i32 2, metadata !84, null}
!103 = metadata !{metadata !104}
!104 = metadata !{i32 0, i32 31, metadata !105}
!105 = metadata !{metadata !106}
!106 = metadata !{metadata !"return", metadata !107, metadata !"int", i32 0, i32 31}
!107 = metadata !{metadata !108}
!108 = metadata !{i32 0, i32 1, i32 0}
!109 = metadata !{i32 786689, metadata !20, metadata !"array", metadata !6, i32 16777252, metadata !10, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!110 = metadata !{i32 36, i32 30, metadata !20, null}
!111 = metadata !{i32 36, i32 43, metadata !112, null}
!112 = metadata !{i32 786443, metadata !20, i32 36, i32 42, metadata !6, i32 11} ; [ DW_TAG_lexical_block ]
!113 = metadata !{i32 37, i32 32, metadata !112, null}
!114 = metadata !{i32 37, i32 58, metadata !112, null}
!115 = metadata !{i32 786689, metadata !17, metadata !"verticalResult", metadata !6, i32 16777246, metadata !9, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!116 = metadata !{i32 30, i32 32, metadata !17, null}
!117 = metadata !{i32 786689, metadata !17, metadata !"horizontalResult", metadata !6, i32 33554462, metadata !9, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!118 = metadata !{i32 30, i32 52, metadata !17, null}
!119 = metadata !{i32 31, i32 2, metadata !120, null}
!120 = metadata !{i32 786443, metadata !17, i32 30, i32 70, metadata !6, i32 10} ; [ DW_TAG_lexical_block ]
