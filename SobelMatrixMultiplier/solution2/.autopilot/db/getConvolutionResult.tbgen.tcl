...
set C_modelArgList {
	{ array_r int 32 regular {array 9 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "array_r", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "array","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 2,"step" : 1},{"low" : 0,"up" : 2,"step" : 1}]}]}]} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			...
			{"Name" : "p_vertical_sobel_oper", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "p_horizontal_sobel_op", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_vertical_sobel_oper_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_horizontal_sobel_op_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	getConvolutionResult {
		array_r {Type I LastRead 4 FirstWrite -1}
		p_vertical_sobel_oper {Type I LastRead -1 FirstWrite -1}
		p_horizontal_sobel_op {Type I LastRead -1 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	array_r { ap_memory {  { array_r_address0 mem_address 1 4 }  { array_r_ce0 mem_ce 1 1 }  { array_r_q0 mem_dout 0 32 } } }
}
