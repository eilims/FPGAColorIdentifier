; ModuleID = 'D:/Repositories/FPGAColorIdentifier/SobelMatrixMultiplier/solution6/.autopilot/db/a.o.bc'
...
define internal i32 @_Z17getVerticalResultPA3_i([3 x i32]* %array) nounwind uwtable {
  ...
  call void @llvm.dbg.declare(metadata !{i32* %summation}, metadata !63), !dbg !64 ; [debug line = 21:6] [debug variable = summation]
  store i32 0, i32* %summation, align 4, !dbg !65 ; [debug line = 21:19]
  br label %3, !dbg !65                           ; [debug line = 21:19]

; <label>:3                                       ; preds = %0
  call void @llvm.dbg.declare(metadata !{i32* %row}, metadata !66), !dbg !68 ; [debug line = 22:21] [debug variable = row]
  store i32 0, i32* %row, align 4, !dbg !69       ; [debug line = 22:28]
  br label %4, !dbg !69                           ; [debug line = 22:28]

; <label>:4                                       ; preds = %35, %3
  %5 = load i32* %row, align 4, !dbg !69          ; [#uses=1 type=i32] [debug line = 22:28]
  %6 = icmp slt i32 %5, 3, !dbg !69               ; [#uses=1 type=i1] [debug line = 22:28]
  br i1 %6, label %7, label %38, !dbg !69         ; [debug line = 22:28]

; <label>:7                                       ; preds = %4
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([9 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !70 ; [debug line = 22:47]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([9 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !70 ; [debug line = 22:47]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !72 ; [debug line = 23:1]
  br label %8, !dbg !72                           ; [debug line = 23:1]
...
; <label>:12                                      ; preds = %9
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([9 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !77 ; [debug line = 23:48]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([9 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !77 ; [debug line = 23:48]
  ...
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([9 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !81 ; [debug line = 25:3]
  br label %31, !dbg !81                          ; [debug line = 25:3]

; <label>:31                                      ; preds = %12
  %32 = load i32* %col, align 4, !dbg !82         ; [#uses=1 type=i32] [debug line = 23:40]
  %33 = add nsw i32 %32, 1, !dbg !82              ; [#uses=1 type=i32] [debug line = 23:40]
  store i32 %33, i32* %col, align 4, !dbg !82     ; [debug line = 23:40]
  br label %9, !dbg !82                           ; [debug line = 23:40]

; <label>:34                                      ; preds = %9
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([9 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !83 ; [debug line = 26:2]
  br label %35, !dbg !83                          ; [debug line = 26:2]

; <label>:35                                      ; preds = %34
  %36 = load i32* %row, align 4, !dbg !84         ; [#uses=1 type=i32] [debug line = 22:39]
  %37 = add nsw i32 %36, 1, !dbg !84              ; [#uses=1 type=i32] [debug line = 22:39]
  store i32 %37, i32* %row, align 4, !dbg !84     ; [debug line = 22:39]
  br label %4, !dbg !84                           ; [debug line = 22:39]
...
; <label>:7                                       ; preds = %4
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([10 x i8]* @.str3, i32 0, i32 0)) nounwind, !dbg !97 ; [debug line = 34:48]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([10 x i8]* @.str3, i32 0, i32 0)) nounwind, !dbg !97 ; [debug line = 34:48]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !99 ; [debug line = 35:1]
  br label %8, !dbg !99                           ; [debug line = 35:1]

; <label>:8                                       ; preds = %7
  call void @llvm.dbg.declare(metadata !{i32* %col}, metadata !100), !dbg !102 ; [debug line = 35:23] [debug variable = col]
  store i32 0, i32* %col, align 4, !dbg !103      ; [debug line = 35:30]
  br label %9, !dbg !103                          ; [debug line = 35:30]

; <label>:9                                       ; preds = %31, %8
  %10 = load i32* %col, align 4, !dbg !103        ; [#uses=1 type=i32] [debug line = 35:30]
  %11 = icmp slt i32 %10, 3, !dbg !103            ; [#uses=1 type=i1] [debug line = 35:30]
  br i1 %11, label %12, label %34, !dbg !103      ; [debug line = 35:30]

; <label>:12                                      ; preds = %9
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([10 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !104 ; [debug line = 35:49]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([10 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !104 ; [debug line = 35:49]
  ...
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([10 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !108 ; [debug line = 37:3]
  br label %31, !dbg !108                         ; [debug line = 37:3]

; <label>:31                                      ; preds = %12
  %32 = load i32* %col, align 4, !dbg !109        ; [#uses=1 type=i32] [debug line = 35:41]
  %33 = add nsw i32 %32, 1, !dbg !109             ; [#uses=1 type=i32] [debug line = 35:41]
  store i32 %33, i32* %col, align 4, !dbg !109    ; [debug line = 35:41]
  br label %9, !dbg !109                          ; [debug line = 35:41]

; <label>:34                                      ; preds = %9
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([10 x i8]* @.str3, i32 0, i32 0)) nounwind, !dbg !110 ; [debug line = 38:2]
  br label %35, !dbg !110                         ; [debug line = 38:2]

; <label>:35                                      ; preds = %34
  %36 = load i32* %row, align 4, !dbg !111        ; [#uses=1 type=i32] [debug line = 34:40]
  %37 = add nsw i32 %36, 1, !dbg !111             ; [#uses=1 type=i32] [debug line = 34:40]
  store i32 %37, i32* %row, align 4, !dbg !111    ; [debug line = 34:40]
  br label %4, !dbg !111                          ; [debug line = 34:40]
...
define i32 @_Z20getConvolutionResultPA3_i([3 x i32]* %array) nounwind uwtable {
  ...
  call void (...)* @_ssdm_op_SpecDataflowPipeline(i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !123 ; [debug line = 52:1]
  %3 = load [3 x i32]** %1, align 8, !dbg !124    ; [#uses=1 type=[3 x i32]*] [debug line = 52:32]
  %4 = call i32 @_Z17getVerticalResultPA3_i([3 x i32]* %3), !dbg !124 ; [#uses=1 type=i32] [debug line = 52:32]
  %5 = load [3 x i32]** %1, align 8, !dbg !125    ; [#uses=1 type=[3 x i32]*] [debug line = 52:58]
  %6 = call i32 @_Z19getHorizontalResultPA3_i([3 x i32]* %5), !dbg !125 ; [#uses=1 type=i32] [debug line = 52:58]
  %7 = call i32 @_Z22combineOperatorResultsii(i32 %4, i32 %6), !dbg !125 ; [#uses=1 type=i32] [debug line = 52:58]
  ret i32 %7, !dbg !125                           ; [debug line = 52:58]
}
...
!63 = metadata !{i32 786688, metadata !62, metadata !"summation", metadata !6, i32 21, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!64 = metadata !{i32 21, i32 6, metadata !62, null}
!65 = metadata !{i32 21, i32 19, metadata !62, null}
!66 = metadata !{i32 786688, metadata !67, metadata !"row", metadata !6, i32 22, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!67 = metadata !{i32 786443, metadata !62, i32 22, i32 12, metadata !6, i32 1} ; [ DW_TAG_lexical_block ]
!68 = metadata !{i32 22, i32 21, metadata !67, null}
!69 = metadata !{i32 22, i32 28, metadata !67, null}
!70 = metadata !{i32 22, i32 47, metadata !71, null}
!71 = metadata !{i32 786443, metadata !67, i32 22, i32 46, metadata !6, i32 2} ; [ DW_TAG_lexical_block ]
!72 = metadata !{i32 23, i32 1, metadata !71, null}
!73 = metadata !{i32 786688, metadata !74, metadata !"col", metadata !6, i32 23, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!74 = metadata !{i32 786443, metadata !71, i32 23, i32 13, metadata !6, i32 3} ; [ DW_TAG_lexical_block ]
...
!82 = metadata !{i32 23, i32 40, metadata !74, null}
!83 = metadata !{i32 26, i32 2, metadata !71, null}
!84 = metadata !{i32 22, i32 39, metadata !67, null}
...
!90 = metadata !{i32 786688, metadata !89, metadata !"summation", metadata !6, i32 33, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!91 = metadata !{i32 33, i32 6, metadata !89, null}
!92 = metadata !{i32 33, i32 19, metadata !89, null}
!93 = metadata !{i32 786688, metadata !94, metadata !"row", metadata !6, i32 34, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!94 = metadata !{i32 786443, metadata !89, i32 34, i32 13, metadata !6, i32 6} ; [ DW_TAG_lexical_block ]
...
!99 = metadata !{i32 35, i32 1, metadata !98, null}
!100 = metadata !{i32 786688, metadata !101, metadata !"col", metadata !6, i32 35, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!101 = metadata !{i32 786443, metadata !98, i32 35, i32 14, metadata !6, i32 8} ; [ DW_TAG_lexical_block ]
!102 = metadata !{i32 35, i32 23, metadata !101, null}
!103 = metadata !{i32 35, i32 30, metadata !101, null}
!104 = metadata !{i32 35, i32 49, metadata !105, null}
!105 = metadata !{i32 786443, metadata !101, i32 35, i32 48, metadata !6, i32 9} ; [ DW_TAG_lexical_block ]
...
!109 = metadata !{i32 35, i32 41, metadata !101, null}
!110 = metadata !{i32 38, i32 2, metadata !98, null}
!111 = metadata !{i32 34, i32 40, metadata !94, null}
