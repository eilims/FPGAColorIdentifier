...
set C_modelArgList {
	{ array_r int 32 regular {array 9 { 1 1 } 1 1 }  }
}
...
set ArgLastReadFirstWriteLatency {
	getConvolutionResult {
		array_r {Type I LastRead 5 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	array_r { ap_memory {  { array_r_address0 mem_address 1 4 }  { array_r_ce0 mem_ce 1 1 }  { array_r_q0 mem_dout 0 32 }  { array_r_address1 mem_address 1 4 }  { array_r_ce1 mem_ce 1 1 }  { array_r_q1 mem_dout 0 32 } } }
}
