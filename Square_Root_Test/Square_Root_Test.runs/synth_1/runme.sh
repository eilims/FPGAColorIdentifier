...
HD_PWD='D:/Documents/ECE520L/Square_Root_Test/Square_Root_Test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Power_Factor_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Power_Factor_2.tcl
