...
`timescale 1 ns / 1 ps
(* rom_style = "distributed" *) module getPixelClassificbkb_rom (
...
initial begin
    $readmemh("./getPixelClassificbkb_rom.dat", ram0);
    $readmemh("./getPixelClassificbkb_rom.dat", ram1);
end
...
getPixelClassificbkb_rom getPixelClassificbkb_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
