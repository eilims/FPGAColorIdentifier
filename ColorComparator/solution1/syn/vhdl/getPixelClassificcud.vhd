...
entity getPixelClassificcud_rom is 
    generic(
             dwidth     : integer := 17; 
             awidth     : integer := 3; 
             mem_size    : integer := 6
...
architecture rtl of getPixelClassificcud_rom is 
...
architecture arch of getPixelClassificcud is
    component getPixelClassificcud_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    getPixelClassificcud_rom_U :  component getPixelClassificcud_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
