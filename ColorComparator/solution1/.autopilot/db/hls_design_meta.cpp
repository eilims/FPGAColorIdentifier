...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("in_pixel_V_TDATA", 24, hls_in, 0, "axis", "in_data", 1),
	Port_Property("in_pixel_V_TVALID", 1, hls_in, 0, "axis", "in_vld", 1),
	Port_Property("in_pixel_V_TREADY", 1, hls_out, 0, "axis", "in_acc", 1),
