...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.getPixelClassification_Stream.autotvin_in_pixel.dat"
         "c.getPixelClassification_Stream.autotvin_out_pixel.dat"
         "c.getPixelClassification_Stream.autotvout_out_pixel.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.getPixelClassification_Stream.autotvout_out_pixel.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
