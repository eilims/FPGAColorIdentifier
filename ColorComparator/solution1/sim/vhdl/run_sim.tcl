...
if {[file isfile getPixelClassification_Stream.autotvin.dat]} {
	file delete -force getPixelClassification_Stream.autotvin.dat
}

if {[file isfile getPixelClassification_Stream.autotvout.dat]} {
	file delete -force getPixelClassification_Stream.autotvout.dat
}
