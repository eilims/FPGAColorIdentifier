...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "getPixelClassification_Stream.autotvin.dat"
	set constFileTvOut       "getPixelClassification_Stream.autotvout.dat"
	set constFileHdlTvIn     "getPixelClassification_Stream.autohdltvin.dat"
	set constFileHdlTvOut    "getPixelClassification_Stream.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
