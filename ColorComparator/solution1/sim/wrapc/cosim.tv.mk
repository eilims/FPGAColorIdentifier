...
$(ObjDir)/ColorComparator_tb.cpp_pre.cpp.tb.o : ColorComparator_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ColorComparator_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/powerFunction.cpp_pre.cpp.tb.o : powerFunction.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling powerFunction.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/ColorComparator.cpp_pre.cpp.tb.o : ColorComparator.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ColorComparator.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
