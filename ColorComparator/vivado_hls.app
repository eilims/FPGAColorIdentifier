<project xmlns="com.autoesl.autopilot.project" name="ColorComparator" top="parseColorsToCenterPixel">
    <includePaths/>
    <libraryPaths/>
    <Simulation>
    ...
    <files xmlns="">
        ...
        <file name="ColorComparator/dataTypes.h" sc="0" tb="false" cflags=""/>
        <file name="ColorComparator/fxp_sqrt.h" sc="0" tb="false" cflags=""/>
